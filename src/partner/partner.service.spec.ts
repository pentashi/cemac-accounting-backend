...
describe('PartnerService', () => {
  ...
  it('should update a client', async () => {
    ...
    service['clientRepo'].findOneBy = jest
      .fn()
      .mockResolvedValue({ id: 1, nom: 'UpdatedClient' });
    service['auditLogService'].log = jest.fn();
  ...
  it('should delete a client', async () => {
    service['clientRepo'].findOneBy = jest
      .fn()
      .mockResolvedValue({ id: 1, nom: 'ClientTest' });
  ...
  it('should create a fournisseur', async () => {
    ...
    service['fournisseurRepo'].save = jest
      .fn()
      .mockResolvedValue({ id: 2, ...dto });
    service['auditLogService'].log = jest.fn();
  ...
  it('should update a fournisseur', async () => {
    ...
    service['fournisseurRepo'].findOneBy = jest
      .fn()
      .mockResolvedValue({ id: 2, nom: 'UpdatedFournisseur' });
    service['auditLogService'].log = jest.fn();
  ...
  it('should delete a fournisseur', async () => {
    service['fournisseurRepo'].findOneBy = jest
      .fn()
      .mockResolvedValue({ id: 2, nom: 'FournisseurTest' });
    service['fournisseurRepo'].delete = jest
      .fn()
